      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link href="/#faq" className="text-sm text-gray-600 hover:text-primary-700 transition-colors">
              FAQ
            </Link>
        ...
        {isOpen && (
          <div className="md:hidden pb-4 border-t border-sand-200 pt-4 space-y-3">
            ...
            <Link href="/#faq" className="block text-sm text-gray-600 py-1" onClick={() => setIsOpen(false)}>
              FAQ
            </Link>
